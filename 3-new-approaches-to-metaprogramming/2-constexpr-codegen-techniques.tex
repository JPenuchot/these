...
is or isn't possible to do with \gls{nttp}\glspluralsuffix{} and \gls{constexpr} functions.
...
\item
The easiest way to get around \gls{nttp} constraints, \ie the pass-by-generator
