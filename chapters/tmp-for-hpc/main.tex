...
% hpcs1:
% Intel, “Math kernel library (mkl).” [Online]. Available:
% http://www.intel.com/software/products/mkl/

% hpcs2:
% AMD, “Amd core math library (acml).” [Online]. Available:
% https://developer.amd.com/amd-cpu-libraries/amd-math-library-libm/

% hpcs3:
% G. Quintana-Ort, E. S. Quintana-Ort, F. G. Zee, R. A. Geijn, and
...
% hpcs5:
% T. Veldhuizen, “Expression templates,” C++ Report, vol. 7, pp. 26–31,
% 1995.
...
% hpcs7:
% J. Falcou, J. S ́erot, L. Pech, and J. Laprest ́e, “Metaprogramming applied
...
% hpcs8:
% K. Czarnecki and U. W. Eisenecker, Generative Programming: Methods,
% Tools, and Applications. New York, NY, USA: ACM Press/Addison-
% Wesley Publishing Co., 2000.

% hpcs9:
% D. Abrahams and A. Gurtovoy, C++ Template Metaprogramming:
