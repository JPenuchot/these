...
how to use mp11 and Brigand to perform a basic task: we first define a list of
arbitrary integers, and then we find the position of the first element 6
in the list.
...
% TODO: revoir l'integration du bloc
