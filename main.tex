...
% to design \gls{dsel}\acrpluralsuffix{}. However, such techniques are limited by the natural syntax
% of \cpp. In this thesis, we explore the benefits of using \cpp23 compile time
% computation features to provide compile time string based \gls{dsel}\acrpluralsuffix{} that can then
...
interpret \cpp code as a \gls{dsel}. Template metaprogramming is such a technique
...
compile time programming are able to help developers designing \gls{dsel}\acrpluralsuffix{} with
...
contribution in the general \gls{dsel}\acrpluralsuffix{} domain, this thesis will explain the core
new techniques enabled by \cpp23 and how we can apply to build two different
\gls{dsel}\acrpluralsuffix{} with their own non-\cpp syntax. We'll also explore the performances of
said \gls{dsel}\acrpluralsuffix{} in term of compile time to assess their usability in realistic code.
