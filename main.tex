...
\textbf{Amal}, dont l'aide m'a \'et\'e pr\'ecieuse pour la pr\'eparation de ma premi\`ere
conf\'erence.

\textbf{Antoine et Alexandrina}, pour leur camaraderie, les d\'ecorations de
f\^etes, les f\^etes dans les champs, et les champs de pizzas.

\textbf{Marie}, pour son soutien moral in\'ebranlable lorsque je m'inqui\'etais pour
le financement de ma th\`ese.

\textbf{Hartmut}, pour son accueil \`a LSU, \textbf{Adrian et Cory},
qui m'ont aid\'e \`a
...
Bien s\^ur \textbf{Joel}, pour son accompagnement bienveillant, valorisant,
et d\'evou\'e depuis mon premier stage de recherche.
...
techniques, we propose a new benchmarking methodology that leverages
...
the second part of this thesis, but before that we will take a look at
how to use \gls{tmp} to generate high performance linear algebra kernels.
...
% TODO: Ca fait pas 15 fois que je repete ca? Abrege frere
