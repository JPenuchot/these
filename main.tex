...
% TODO:
% - Loi de Moore etc...
% - Qu'est-ce que le parallelisme (la fin du free lunch -> on parallelise)
% - Qu'est-ce que la generation de code/metaprog
% - Quels sont les grands outils (citer les rapporteureuses)?
% - Objectifs de la these
%   - C'est complique la programmation parallele (3 vendeurs de GPUs???)
%     du coup on fait des outils qui generent du code parallele
