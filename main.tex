...
\newcommand{\dsl}{\textit{DSL}}
\newcommand{\dsls}{\textit{DSL}s}
\newcommand{\dsel}{\textit{DSEL}}
\newcommand{\dsels}{\textit{DSEL}s}
...
\lstset{
  ...
  keywordstyle=\color{C4},
  commentstyle=\color{A5},
...
\tikz[remember picture,overlay] \node[opacity=1,inner sep=0pt] at (-13mm,-135mm){\includegraphics{ups/frame.pdf}};
...
\textbf{Titre:} Techniques avanc\'ees de ge\'ne\'ration de code
pour le paralle\'lisme
...
\subfile{chapters/gemv/main.tex}
\subfile{chapters/blaze/main.tex}

\part{Metaprogramming, code generation beyond expression templates}
