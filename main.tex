...
Amal, dont l'aide m'a \'et\'e pr\'ecieuse pour la pr\'eparation de ma premi\`ere
conf\'erence.

Antoine et Alexandrina, pour leur camaraderie, les d\'ecorations de
f\^etes, les f\^etes dans les champs, et les champs de pizzas.

Marie, pour son soutien moral in\'ebranlable lorsque je m'inqui\'etais pour
le financement de ma th\`ese.

Hartmut, pour son accueil \`a LSU, Adrian et Cory, qui m'ont aid\'e \`a
traverser une \'ev\'enement difficile et marquant pendant mon s\'ejour,
et bien s\^ur le reste de l'\'equipe Ste||ar pour les amiti\'es
que j'ai pu y nouer, et la gentillesse de chaque personne
que j'y ai rencontr\'ee.

Bien s\^ur Joel, pour son accompagnement bienveillant, valorisant,
