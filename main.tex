...
% to design \acrshort{dsel}\acrpluralsuffix{}. However, such techniques are limited by the natural syntax
% of \cpp. In this thesis, we explore the benefits of using \cpp23 compile time
% computation features to provide compile time string based \acrshort{dsel}\acrpluralsuffix{} that can then
