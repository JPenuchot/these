...
\providecommand{\sfinae}{\textsc{SFINAE}\xspace}
\providecommand{\tmp}{template metaprogramming\xspace}
\providecommand{\Tmp}{Template metaprogramming\xspace}
...
\subfile{1-current-metaprogramming/beyond-cpp.tex}
