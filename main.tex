...
\subfile{2-tmp-for-hpc/beyond-cpp.tex}
\subfile{2-tmp-for-hpc/cpp-constructs.tex}

\chapter{
  Code generation at low level
}

\subfile{2-tmp-for-hpc/low-level.tex}

\chapter{
  Code generation at expression level
}

\subfile{2-tmp-for-hpc/expression-level.tex}
...
\subfile{4-ctbench/state-of-the-art.tex}
\subfile{4-ctbench/features-and-design.tex}
\subfile{4-ctbench/ctbench-in-action.tex}
...
\subfile{3-poacher/3-brainfuck.tex}
\subfile{3-poacher/4-math-parsing.tex}
